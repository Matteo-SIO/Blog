...
abstract class Article implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Blog\\Map\\ArticleTableMap';
    ...
    /**
     * Initializes internal state of Blog\Base\Article object.
     * @see applyDefaults()
     */
    ...
    public function setCreatedat($v)
    {
        ...
        if ($this->createdat !== null || $dt !== null) {
            if ($this->createdat === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->createdat->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ArticleTableMap::COL_CREATEDAT] = true;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArticleTableMap::translateFieldName('Createdat', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->createdat = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArticleTableMap::translateFieldName('PublisherId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Blog\\Article'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ArticleTableMap::COL_CREATEDAT)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ArticleTableMap::COL_CREATEDAT)) {
            $criteria->add(ArticleTableMap::COL_CREATEDAT, $this->createdat);
        }
        if ($this->isColumnModified(ArticleTableMap::COL_PUBLISHER_ID)) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \Blog\Article (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Blog\Article Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getPublisherObj(?ConnectionInterface $con = null)
    {
        if ($this->aPublisherObj === null && ($this->publisher_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublisherObj->addArticles($this);
             */
        }
    ...
    public function setComments(Collection $comments, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($commentsToDelete as $commentRemoved) {
            $commentRemoved->setArticleObj(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildComment}> List of ChildComment objects
     */
    public function getCommentsJoinPublisherObj(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCommentQuery::create(null, $criteria);
        $query->joinWith('PublisherObj', $joinBehavior);
    ...
    {
        if (null !== $this->aPublisherObj) {
            $this->aPublisherObj->removeArticle($this);
        }
        $this->id = null;
        $this->createdat = null;
